...
public class ReproductorActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().getDecorView().setBackgroundColor(Color.parseColor("#09a55f"));
    ...
    protected void onResume() {
        ...
        if (mPlayer != null) {
            mPlayer.addNotificationCallback(ReproductorActivity.this);
            mPlayer.addConnectionStateCallback(ReproductorActivity.this);
        }
    }
        ...
        if (mPlayer == null) {
            ...
            mPlayer = Spotify.getPlayer(playerConfig, this, new SpotifyPlayer.InitializationObserver() {
                ...
                public void onInitialized(SpotifyPlayer player) {
                    ...
                    mPlayer.setConnectivityStatus(mOperationCallback, getNetworkConnectivity(ReproductorActivity.this));
                    mPlayer.addNotificationCallback(ReproductorActivity.this);
                    mPlayer.addConnectionStateCallback(ReproductorActivity.this);
                    // Trigger UI refresh
                    updateView();
    ...
    protected void onPause() {
        ...
        // paused.
        if (mPlayer != null) {
            mPlayer.removeNotificationCallback(ReproductorActivity.this);
            mPlayer.removeConnectionStateCallback(ReproductorActivity.this);
        }
    }
